...
public class IgnoreRulesTableModelTests
{
	...
	{		
		...
		assertThat(_tableModel.getValueAt(0, 0), is((Object)new ScreenValueForTest("rule-1")));
		assertThat(_tableModel.getValueAt(1, 0), is((Object)new ScreenValueForTest("rule-2")));
	}
